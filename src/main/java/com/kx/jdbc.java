...
public class jdbc implements Driver {
    ...
    public class co implements Connection {
        ...
        public void setCatalog(String s) throws SQLException {
            q("setCatalog not supported");
        }

        public String getCatalog() throws SQLException {
            q("getCatalog not supported");
            return null;
        }
    ...
    public class st implements Statement {
        ...
        private int maxRows = 0, T, fetchSize = 0;
        protected Object[] p = {};
        ...
        public void setMaxRows(int n) throws SQLException {
            if (n < 0) q("setMaxRows(int), rows must be >=0. Passed " + n);
            maxRows = n;
        }
        ...
        public void setFetchDirection(int direction) throws SQLException {
            q("setFetchDirection not supported");
        }
        ...
        public void setFetchSize(int rows) throws SQLException {
            if (fetchSize < 0) throw new SQLException("setFetchSize(rows), rows must be >=0. Passed" + fetchSize);
            fetchSize = rows;
        }
    ...
    public class ps extends st implements PreparedStatement {
        ...
        public ParameterMetaData getParameterMetaData() throws SQLException {
            q("getParameterMetaData not supported");
            return null;
        }
    ...
    public class rs implements ResultSet {
        ...
        public int getInt(int i) throws SQLException {
            Object x = getObject(i);
            return x == null ? 0 : x instanceof Integer ? ((Integer) x).intValue() : ((Short) x).intValue();
        }
        ...
        public Timestamp getTimestamp(int i) throws SQLException {
            ...
            return o instanceof java.util.Date ? new Timestamp(((java.util.Date) o).getTime()) : (Timestamp) o;
        }
        ...
        public String getCursorName() throws SQLException {
            q("getCursorName not supported");
            return "";
        }

        public void close() throws SQLException {
            d = null;
            if (st != null) while (null != st.co.getMoreRows()) ;
        }// drain remaining streamed messages
        ...
        public int getFetchSize() throws SQLException {
            return st != null ? st.getFetchSize() : 0;
        }

        public int getType() throws SQLException {
            return streamed ? TYPE_FORWARD_ONLY : TYPE_SCROLL_SENSITIVE;
        }
    ...
    public class rm implements ResultSetMetaData {
        ...
        public String getColumnClassName(int column) throws SQLException {
            q("getColumnClassName not supported");
            return null;
        }
